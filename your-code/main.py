...
#print(f"La configuracion de Numpy es: {np.show_config()}")
...
#[tu código aquí]
print("Tienen 'a' y 'b' el mismo tamaño?: " + "Sí" if a.size==b.size else "No")

#8. ¿Es posible sumar a y b? ¿Por qué sí o por qué no?

#[tu código aquí]
print("Es posible sumar 'a' y 'b'?: " + "No, ya que no tienen la misma forma" if a.shape!=b.shape else "Sí, ya que tienen la misma forma")
...
#[tu código aquí]
print("Es 'e' igual a 'a'?: " + ("No, ya que 'c' no es el elemento neutro del producto" if not np.array_equal(e,a) else "Si, ya que 'c' es el elemento neutro del producto"))
...
print("f tiene el valor esperado" if np.array_equal(f,f_solution) else "f no tiene el valor esperado") 
...
print("f_str tiene el valor esperado" if np.array_equal(f_str,f_solution_str) else "f_str no tiene el valor esperado") 
